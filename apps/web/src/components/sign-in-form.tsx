  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      await authClient.signIn.email(
        ...
        {
          onSuccess: () => {
             // Force hard refresh or router refresh to ensure session is picked up
  ...
  return (
    <div className="w-full">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-primary">Login here</h1>
        <p className="mt-2 text-xl font-semibold">Welcome back you've been missed!</p>
      </div>
              ...
              <div className="space-y-2">
                ...
                />
                 ...
                 <div className="flex justify-end">
                    <Button variant="link" className="px-0 text-sm text-muted-foreground">Forgot your password?</Button>
                 </div>
              </div>
            )}
          </form.Field>
      ...
      <div className="mt-8 text-center text-sm font-medium text-muted-foreground">
        <button type="button" onClick={onSwitchToSignUp} className="hover:text-primary transition-colors">
            Create new account
        </button>
      </div>
